---
title: "Key Takeaways"
description: "Generate Key Takeaways Section"
icon: 'key'
---
...
```bash cURL
curl -X POST \
  https://your-domain.com/key-takeaways \
...
```bash PHP
$url = 'https://your-domain.com/key-takeaways';
$data = array(
    'text' => 'Sample Key Takeaways Text'
);
...
```bash JavaScript
const url = 'https://your-domain.com/key-takeaways';
const headers = {
    'Content-Type': 'application/json',
    'X-API-Key': 'YOUR_API_KEY'
};
