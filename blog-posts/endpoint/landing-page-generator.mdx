...
<ParamField body="validation_url" type="string">
    This is your website URL. You must have the Contentify plugin installed on your website and an API key to use this endpoint.
    The url must start with http:// or https:// and must not end with a slash.
</ParamField>
