...
<iframe 
    src="https://player.vimeo.com/video/972625691?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" 
    frameborder="0" 
    style="position:absolute;top:0;left:0;width:400px;height:700px;" 
    title="Sample Video">
</iframe>
...
<iframe
  width="400"
  height="700"
  src="https://www.youtube.com/shorts/dcGxbBPR_O8"
...
```bash PHP
<?php
$url = '<BASE_URL>/generate-slideshow-2';
$data = array(
    "article" => "Article content",
    "branding" => "Brand X",
    "voice_id" => "voice_123",
...
```bash JavaScript
const url = '<BASE_URL>/generate-slideshow-2';
const headers = {
    'Content-Type': 'application/json',
    'X-API-Key': 'YOUR_API_KEY'
};
