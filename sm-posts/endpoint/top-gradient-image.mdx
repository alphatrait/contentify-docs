...
<img height="200" src="https://mintlify.s3-us-west-1.amazonaws.com/contentify/images/top-gradient-image.png" className="rounded-xl"/>

### Body

Generate social media image post with text over gradient background at the top of the image.
...
<ResponseField name="top_gradient_image_post" type="string">
  The post URL.
</ResponseField>
