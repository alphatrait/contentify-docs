...
<img height="200" src="https://mintlify.s3-us-west-1.amazonaws.com/contentify/images/glass-over-image.png" className="rounded-xl"/>

### Body

Generate social media image post with text over glassmorphism style background at the bottom of the image.
...
<ResponseField name="glass_over_image_post" type="string">
  The post URL.
</ResponseField>
